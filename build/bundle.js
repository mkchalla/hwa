var app = (function () {
    ...
    /* src/PorgressBar.svelte generated by Svelte v3.50.1 */
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-o8wg32");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-o8wg32");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    class PorgressBar extends SvelteComponent {
    	constructor(options) {
    		super();
    ...
    function create_fragment$2(ctx) {
    	...
    	let mounted;
    	let dispose;
    	porgressbar = new PorgressBar({ props: { progress: /*progress*/ ctx[1] } });
    	...
    	return {
    		c() {
    			...
    			t2 = space();
    			create_component(porgressbar.$$.fragment);
    			t3 = space();
    			div1 = element("div");
    			button = element("button");
    			t4 = text("Start");
    			attr(h2, "bp", "offset-5@md 4@md 12@sm");
    			attr(h2, "class", "svelte-2spg8e");
    			attr(div0, "bp", "grid");
    			attr(button, "bp", "offset-5@md 4@md 12@sm");
    			attr(button, "class", "start svelte-2spg8e");
    			button.disabled = /*isRunning*/ ctx[2];
    			attr(div1, "bp", "grid");
    		},
    		m(target, anchor) {
    			...
    			mount_component(porgressbar, target, anchor);
    		...
    		p(ctx, [dirty]) {
    			...
    			const porgressbar_changes = {};
    			if (dirty & /*progress*/ 2) porgressbar_changes.progress = /*progress*/ ctx[1];
    			porgressbar.$set(porgressbar_changes);

    			if (!current || dirty & /*isRunning*/ 4) {
    				button.disabled = /*isRunning*/ ctx[2];
    			}
    		},
    		i(local) {
    			if (current) return;
    			transition_in(porgressbar.$$.fragment, local);
    			current = true;
    		},
    		o(local) {
    			transition_out(porgressbar.$$.fragment, local);
    			current = false;
    		},
    		d(detaching) {
    			if (detaching) detach(div0);
    			if (detaching) detach(t2);
    			destroy_component(porgressbar, detaching);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [secondsLeft, progress, isRunning, startTimer];
    }
